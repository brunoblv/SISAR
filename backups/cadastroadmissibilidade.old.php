...
<body>
	...
	<div id="content" class="p-4 p-md-5 pt-5">
		<div class="input-group" id="tabela">
			...
			<div class="table-responsive">
				<div class="badge bg-primary text-wrap" style="width: 15rem;">
					PROCESSOS AGUARDANDO ADMISSIBILIDADE
				</div>
				<br>
				<br>
				<table class="table table-bordered">
					...
					<tbody>
						...
						?>
							<tr>
								<td><a class='btn btn-info btn-xs copiar botaoselecao'><span class="glyphicon glyphicon-edit"></span>Selecionar</a></td>
		...
		<div id="form" hidden>
			<h4 class="mb-3">Admissibilidade</h4>
			<hr class="mb-4">
