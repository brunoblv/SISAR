...
if(isset($_POST['salvar'])) {	
    ...
    $uso = mysqli_real_escape_string($mysqli, $_POST['uso']);
    ...
    $stmt = $mysqli->prepare("INSERT INTO inicial (conclusao, obs, numsql, tipo, req, fisico, aprovadigital, sei, dataprotocolo, tipoprocesso, tipoalvara1, tipoalvara2, tipoalvara3, stand, categoria, sts, descstatus, decreto) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("isssssssssssssssss", $conclusao, $obs, $numsql, $tipo, $req, $fisico, $digital, $sei, $dataprotocolo, $tipoprocesso, $alv1, $alv2, $alv3, $stand, $uso, $status, $descstatus, $decreto);
    $stmt->execute();    
