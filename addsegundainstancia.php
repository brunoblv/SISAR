...
if(isset($_POST['salvar'])) {	
    ...
    $mysqli->query("INSERT INTO segundainstancia (controleinterno,datainicio, datalimite, datagendada, datareal,motivodatadistinta, parecer, datapubliparecer, datacumprimento,datalimite2,
